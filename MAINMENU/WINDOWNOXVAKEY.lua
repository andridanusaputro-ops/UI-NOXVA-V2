-- ==========================================
-- NOXVA HUB - WINDOW KEY SYSTEM (UI)
-- DEVELOPED BY DANZY (Ultra Clean UI)
-- ==========================================

-- 1. Panggil Logic Key System
local LogicMainMenu = _G.GetNoxvaFile("MAINMENU/LOGICMAINmenu.lua")
...
local function LoadNoxvaHub()
    ...
    _G.NoxvaLib = _G.GetNoxvaFile("uiNoxvaV2.lua")
    
    -- JALANKAN SCRIPT SESUAI DATABASE DI NOXVAmain.lua
    if _G.NoxvaSupportedGames and _G.NoxvaSupportedGames[PlaceId] then
        _G.NoxvaSupportedGames[PlaceId].Execute()
    end
end
